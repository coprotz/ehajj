...
import Image2 from '../../components/images/kaaba.jpg'
...
const Teachings = () => {
  ...
  return (
    <div className='home'>
      <Main/>
      <div className='teachings_wrapper'>
        <div className="teachings_inner">
          <div className="page_title_wrapper agent_top">
              <h1 className='page_title'><FaArrowLeft onClick={() => navigate('/agents')}/>Mafunzo na Habari</h1>
              <button className='page_next' onClick={() => navigate('/contact')}><FaArrowRight /></button>
          </div>
